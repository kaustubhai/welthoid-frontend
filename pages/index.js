    ...
    <>
      ...
      <div className="flex justify-center items-center flex-col">
        <Head>
          ...
          <meta
            name="description"
            content="Welthoid is a super user friendly for beginers in the stock market. Here you can invest virtual Mose Bucks into the real stock market exchange and track your virtual money going up and down in real market"
          />
          <meta
            name="keywords"
            content="Kaustubhai, Stock, Market, Investment, Practice, Realtime, mern stack, web projects, react, node, express, college project"
          />
        ...
        >
          <div className="text w-full lg:block flex flex-col items-center justify-center lg:w-5/12">
            ...
            <p className=" text-center lg:text-left lg:ml-20 my-5 lg:mt-10 text-xl w-3/4">
              Gets your hand dirty with real stock market but fake money, called
              the "Mose-Buck".
            </p>
            <GoogleLogin
              ...
              render={(renderProps) => (
                ...
                >
                  <button
                    type="button"
                    className="py-4 px-4 rounded-lg lg:ml-20 my-10 bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white text-center  lg:w-full w-40 max-w-sm lg:max-w-md transition ease-in duration-200 text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 "
                  >
                    Start Now
                  </button>
                </a>
        ...
        <h2 className="mb-10 text-4xl text-center font-body font-bold">
          Our Features
        </h2>
        ...
        >
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-gray-800">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              You can learn starting investing from great mentors from all of
              the world and get your hands dirty with real time stock prices
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 mt-6 sm:mt-16 md:mt-20 lg:mt-24 bg-white shadow-lg rounded-lg dark:bg-gray-800">
            ...
            <p className="text-md text-gray-500 dark:text-gray-300 py-4">
              At the time of login, you get 10000 Mose bucks to start your
              investing. You can earn more or loose only by investing in market
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-lg dark:bg-gray-800">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              We fetch real time data from world class APIs so that you can get
              training like real time trading and get pro of it
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-gray-800">
            <div className="flex-shrink-0">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              We have designed interactive UI for every thing you need so that
              you dont get lost as a beginner in this huge market
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 mt-6 sm:mt-16 md:mt-20 lg:mt-24 bg-white shadow-lg rounded-lg dark:bg-gray-800">
            <div className="flex-shrink-0">
            ...
            <p className="text-md text-gray-500 dark:text-gray-300 py-4">
              You can check all the losses or gains you made while mock trading
              with us in your dashboard with all the statistics
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-lg dark:bg-gray-800">
            <div className="flex-shrink-0">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              Get list of stocks on the spotlight because of their high movement
              all at one place so that you dont need to hand-pick stocks
            </p>
          </div>
        </section>

        <section id="action" className="bg-white dark:bg-gray-800 my-10">
          <div className="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
            <h2 className="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
              <span className="block font-body">Want to be millionaire ?</span>
              <span className="block text-red-600 font-body">
                Start investing now.
              </span>
            </h2>
