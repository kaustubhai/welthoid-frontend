...
const TradeModal = ({symbol, price, onCloseModal}) => {
  ...
  return (
    <div className="flex justify-center items-center px-16 pb-8 flex-col">
        ...
        <h1 className="text-green-500 px-5 pb-10 text-xl font-bold font-body">
        ...
        <form>
            <div className="stock flex w-full justify-around py-4">
                <input value={quantity} onChange={(e) => setQuantity(e.target.value)} required type="number" step="1" className="rounded border-2 font-body p-2 border-gray-300" placeholder="Enter Quantity" />
            </div>
