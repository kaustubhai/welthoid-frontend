...
const Footer = () => {
  return (
    <footer className="px-3 py-8 bg-white border-t-2 border-gray-300 dark:bg-gray-800 text-2 text-gray-500 shadow-2xl dark:text-gray-200 transition-colors duration-200">
